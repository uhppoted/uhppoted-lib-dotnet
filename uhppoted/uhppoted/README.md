...
- CLI:
```
dotnet add package uhppoted --version 0.8.9.7-beta

```

- _Package Manager_ (console):
```
NuGet\Install-Package uhppoted -Version 0.8.9.7-beta
```
...
```
  ...
  <ItemGroup>
    <PackageReference Include="uhppoted" Version="0.8.9.7-beta" />
  </ItemGroup>
  ...
```
