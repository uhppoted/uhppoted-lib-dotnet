                    ...
                    { Door1Open = response.door1Open
                      ...
                      Relays =
                        { Door1 = Enums.relay response.relays 0x01uy
                          Door2 = Enums.relay response.relays 0x02uy
                          Door3 = Enums.relay response.relays 0x04uy
                          Door4 = Enums.relay response.relays 0x08uy }
                      Inputs =
                        { LockForced = Enums.input response.inputs 0x01uy
                          FireAlarm = Enums.input response.inputs 0x02uy
                          Input3 = Enums.input response.inputs 0x04uy
                          Input4 = Enums.input response.inputs 0x08uy
                          Input5 = Enums.input response.inputs 0x10uy
                          Input6 = Enums.input response.inputs 0x20uy
                          Input7 = Enums.input response.inputs 0x40uy
                          Input8 = Enums.input response.inputs 0x80uy } }
                    ...
                    { Door1Open = e.door1Open
                      ...
                      Relays =
                        { Door1 = Enums.relay e.relays 0x01uy
                          Door2 = Enums.relay e.relays 0x02uy
                          Door3 = Enums.relay e.relays 0x04uy
                          Door4 = Enums.relay e.relays 0x08uy }
                      Inputs =
                        { LockForced = Enums.input e.inputs 0x01uy
                          FireAlarm = Enums.input e.inputs 0x02uy
                          Input3 = Enums.input e.inputs 0x04uy
                          Input4 = Enums.input e.inputs 0x08uy
                          Input5 = Enums.input e.inputs 0x10uy
                          Input6 = Enums.input e.inputs 0x20uy
                          Input7 = Enums.input e.inputs 0x40uy
                          Input8 = Enums.input e.inputs 0x80uy } }
